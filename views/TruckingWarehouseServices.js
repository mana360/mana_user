    ...
    onResponse(apiConstant, data) {
        switch (apiConstant) {
            case ApiConstants.getDashboardData:
                if (data.status) {
                    let current_trips = data.dashboard_data.truck_warehouse_booking.current_trips;
                    let upcoming_trips = data.dashboard_data.truck_warehouse_booking.upcoming_trips;
                    if (data && data.dashboard_data && data.dashboard_data.truck_warehouse_booking) {
                        ...
                        this.setState({
                            truckWarehouseServiceData: localArray
                        })
                    }
                } else {
                    // alert(data.message)
